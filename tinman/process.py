...
class Process(multiprocessing.Process):
    ...
    @property
    def http_server_arguments(self):
    ...
    def _create_application(self):
        ...
        """
        return application.Application(self.routes, self._port, **self.settings)
    ...
    def _create_http_server(self):
        ...
        """
        return self._start_httpserver(self._port, self.http_server_arguments)
